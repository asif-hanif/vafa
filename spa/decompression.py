...
def idct_3d(dct_image):
    ...
    # return idct_image+128  # making pixel/voxel range to [0,255] due to zero centring in dct_3d()
    return idct_image + 0.5  # making pixel/voxel range to [0,1] due to zero centring in dct_3d()
...
def idct_2d(dct_image):
    ...
    # return idct_image+128  # making pixel/voxel range to [0,255] due to zero centring in dct_2d()
    return idct_image + 0.5  # making pixel/voxel range to [0,1] due to zero centring in dct_2d()
